...
Route::group(['middleware' => ['installer']], function () {
    ...
    Route::group(['prefix' => 'admin/products', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        ...
        Route::get('/detail/{id}', 'ProductController@detail')->middleware('edit_product');
        Route::post('/update', 'ProductController@update')->middleware('edit_product');

        Route::post('/publish', 'ProductController@publish')->middleware('edit_product');
        Route::post('/decline', 'ProductController@decline')->middleware('edit_product');
        Route::post('/acceptchange', 'ProductController@acceptchange')->middleware('edit_product');
        Route::post('/declinechange', 'ProductController@declinechange')->middleware('edit_product');
    ...
    Route::group(['prefix' => 'admin/vendors', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        ...
        Route::post('/addvendoraddress', 'VendorsController@addvendoraddress')->middleware('add_customer');
