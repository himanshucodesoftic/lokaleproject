...
<script src="{!! asset('web/js/theme_js/common_scripts.js') !!}"></script>

<script src="{!! asset('web/js/theme_js/main.js') !!}"></script>
<script src="{!! asset('web/js/theme_js/carousel-home.min.js') !!}"></script>
<script src="{!! asset('web/js/theme_js/specific_listing.js') !!}"></script>
<script src="{!! asset('web/js/theme_js/sticky_sidebar.min.js') !!}"></script>
...
function changeLangHeader(lang_id) {	
	console.log(lang_id);
	myFunction1(lang_id);
}
...
beforeSend: function (xhr) { // Add this line
  ...
  success: function (res) {
    ...
    if(obj.success==0){
	  ...
	  jQuery('.total_wishlist').html("<strong>"+obj.total_wishlist+"</strong>");
