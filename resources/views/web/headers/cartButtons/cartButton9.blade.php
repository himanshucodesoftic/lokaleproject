...
<div class="tt-cart tt-dropdown-obj" style="border:2px solid red;" data-tooltip="Cart" data-tposition="bottom" style="border:2px solid red;">
												...
												<div class="tt-item">
													<a href="product.html">
														<div class="tt-item-img">
															<img src="{{asset('').$cart_data->image}}"  width="50" height="50" alt="{{$cart_data->products_name}}">
														</div>
														<div class="tt-item-descriptions">
															...
															<div class="tt-quantity"> X1</div> <div class="tt-price">{{$cart_data->customers_basket_quantity}} x {{$cart_data->products_name}}</span>{{Session::get('symbol_left')}}{{$cart_data->final_price*session('currency_value')}}{{Session::get('symbol_right')}}</div>
														</div>
													</a>
