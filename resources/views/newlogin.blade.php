...
<head>
		<meta charset="utf-8">
	<title>Lokalkw - Login Page</title>
	<meta name="keywords" content="">
	<meta name="description" content="Lokalkw - Login Page">
	<meta name="author" content="Lokalkw">
...
<div id="tt-pageContent">
	<div class="container-indent">
		<div class="container">
			<h1 class="tt-title-subpages noborder">@lang('home.msg')</h1>
							...
							<div class="form-default form-top">
								<form id="customer_login" method="post" novalidate="novalidate">
									<div class="form-group">
										...
										<input type="text" name="name" class="form-control" id="loginInputName" placeholder="Enter Your E-mail">
									</div>
									<div class="form-group">
							...
							<div class="form-default form-top">
								<form id="customer_login" method="post" novalidate="novalidate">
									...
									<div class="form-group">
										...
										<input type="text" name="confirmpassowrd" class="form-control" id="loginInputEmail" placeholder="Confirm Password">
									</div>
									<div class="row">
										<div class="col-xs-12 col-md-6"> 
											<div class="form-group">
									...
									<div class="row">
										<div class="col-xs-12 col-md-6"> 
											<div class="form-group">
												...
												<input type="date" name="dateofbirth" class="form-control" id="loginInputDOB" placeholder="Confirm Password">
											</div>	
										</div>
										<div class="col-xs-12 col-md-6"> 
											<div class="form-group">
