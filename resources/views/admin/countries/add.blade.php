...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> AddCountry<small>AddCountry...</small> </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">AddCountry</h3>
                        </div>
                                    ...
                                    <div class="box box-info"><br>
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">CountryName
                                                </label>
