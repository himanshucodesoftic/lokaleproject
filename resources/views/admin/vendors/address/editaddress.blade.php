<div class="modal-header">
    ...
    <h4 class="modal-title" id="editManufacturerLabel">EditAddress</h4>
</div>
...
<div class="modal-body">
    ...
    <div class="form-group">
        <label for="name" class="col-sm-2 col-md-3 control-label">FirstName*</label>
        <div class="col-sm-10 col-md-8">
    ...
    <div class="form-group">
        <label for="name" class="col-sm-2 col-md-3 control-label">LastName*</label>
        <div class="col-sm-10 col-md-8">
    ...
    <div class="form-group">
        <label for="name" class="col-sm-2 col-md-3 control-label">StreetAddress*</label>
        <div class="col-sm-10 col-md-8">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary form-validate" id="updateAddress">Submit</button>
</div>
{!! Form::close() !!}
