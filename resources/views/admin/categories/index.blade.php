...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Categories <small>ListingAllMainCategories...</small> </h1>
            <ol class="breadcrumb">
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('admin/categories/add')}}" type="button" class="btn btn-block btn-primary">AddNewCategory</a>
                            </div>
                        </div>
                                        ...
                                        @if(count($categories)>0)
                                            ...
                                            @foreach ($categories as $key=>$category)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <strong>AddedDate: </strong> {{ $category->date_added }}<br>
                                                            <strong>ModifiedDate: </strong>{{ $category->last_modified }}
                                                        </td>
                                                        <td>
