...
<header id="tt-header">
	...
	<nav class="panel-menu mobile-main-menu">
		<ul>
			...
			<li>
				...
				<ul>
					<li>
						<a href="listing-left-column.html">T-Shirt</a>
						<ul>
					...
					<li>
						<a href="product-variable.html">KIDS</a>
						<ul>
					...
					<li>
						<a href="shopping_cart_02.html">cONTACT US</a>
						<ul>
	...
	<!-- tt-desktop-header -->
	<div class="tt-desktop-header text-center justify-content-center" style="background-color:#2a5b80;">
		<div class="container">
			<div class="tt-header-holder">
				<div class="tt-col-obj tt-obj-logo">
					<!-- logo -->
					<a class="tt-logo tt-logo-alignment" href="index.html"><img src="https://lokalkw.com/images/logo.png" alt=""></a>
					<!-- /logo -->
				</div>
				...
				<div class="tt-col-obj tt-obj-options obj-move-right">
					...
					<!-- /tt-search -->
						<!-- tt-wishlist -->
						<div class="tt-desctop-parent-heart tt-parent-box">
							<div class="tt-heart tt-dropdown-obj" data-tooltip="WishList" data-tposition="bottom">
					...
					<div class="tt-desctop-parent-cart tt-parent-box">
						<div class="tt-cart tt-dropdown-obj" data-tooltip="Cart" data-tposition="bottom">
							<button class="tt-dropdown-toggle">
								<i class="fal fa-shopping-bag"></i>								<span class="tt-badge-cart">3</span>
							</button>
							<div class="tt-dropdown-menu">
					...
					<div class="tt-desctop-parent-account tt-parent-box">
						<div class="tt-account tt-dropdown-obj">
							<button class="tt-dropdown-toggle"  data-tooltip="My Account" data-tposition="bottom"><i class="fal fa-user"></i></button>
							<div class="tt-dropdown-menu">
								<div class="tt-mobile-add">
									<button class="tt-close">Close</button>
								</div>
								<div class="tt-dropdown-inner">
									<ul>
									    ...
									    <li><a href="login.html"><i class="icon-f-94"></i>Register</a></li>
									</ul>
								</div>
							</div>
						</div>
