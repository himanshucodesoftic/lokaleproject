...
class Categories extends Model
{
    ...
    public function insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status,$categories_available){
        $categories = DB::table('categories')->insertGetId([
            ...
            'visibility' => $categories_available
        ]);
        return $categories;
    }
    ...
    public function updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status,$categories_available){
    ...
    public function editsubcategory($request){
        $editSubCategory = DB::table('categories')
            ...
            'categories.categories_slug as slug', 'categories.categories_status as categories_status', 'categories.parent_id as parent_id','categoryTable.path as imgpath','iconTable.path as iconpath','categories.visibility as cat_visibility')
            ->where('categories.categories_id', $request->id)->get();
