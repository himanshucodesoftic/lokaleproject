...
class Manufacturers extends Model
{
    public function __construct()
  {
    ...
    public $sortable = ['manufacturers_id', 'manufacturer_name', 'manufacturer_image','manufacturers_slug','created_at','updated_at', 'Name_English', 'Name_Arabic'];
    ...
    public function paginator(){
         $manufacturers =  Manufacturers::sortable(['manufacturers_id'=>'desc'])
                ...
                'manufacturers.manufacturer_name as name', 'manufacturers_info.manufacturers_url as url', 'manufacturers_info.url_clicked', 'manufacturers.Name_Arabic as name_ar', 
    ...
    public function getter($language_id){
         ...
         $manufacturers =  Manufacturers::sortable(['manufacturers_id'=>'desc'])
            ...
            ->select('manufacturers.manufacturers_id as id', 'manufacturers.manufacturer_image as image',  'manufacturers.manufacturer_name as name', 'manufacturers_info.manufacturers_url as url', 'manufacturers_info.url_clicked', 'manufacturers_info.date_last_click as clik_date','image_categories.path as path', 'manufacturers.Name_Arabic as name_ar')
    ...
    public function fetchAllmanufacturers($language_id){
        ...
        $getManufacturers = DB::table('manufacturers')
            ->leftJoin('manufacturers_info','manufacturers_info.manufacturers_id', '=', 'manufacturers.manufacturers_id')
            ->select('manufacturers.manufacturers_id as id', 'manufacturers.manufacturer_image as image',  'manufacturers.manufacturer_name as name', 'manufacturers_info.manufacturers_url as url', 'manufacturers_info.url_clicked', 'manufacturers_info.date_last_click as clik_date', 'manufacturers.Name_Arabic as name_ar')
