...
class ProductController extends Controller
{
    ...
    public function detail(Request $request)
    {
        ...
        $title = array('pageTitle' => Lang::get("labels.EditProduct"));
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.products.detail", $title)->with('result', $result)->with('allimage', $allimage);
    ...
    {
        $this->products->publish($request);
        return redirect('admin/products/display');        
    }

    public function decline(Request $request)
    {
        $this->products->decline($request);
        return 'sucess';
    }

    public function acceptchange(Request $request)
    {
        $this->products->acceptchange($request);
        return 'sucess';
    }

    public function declinechange(Request $request)
    {
        $this->products->declinechange($request);
        return 'sucess';
    }
