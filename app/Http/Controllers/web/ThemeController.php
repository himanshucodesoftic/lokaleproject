  ...
  public function theme()
    {
        ...
        $header_id = 9;//$data->header;
        $carousel_id = 1;//$data->carousel;
        $banner_id = 8;//$data->banner;
        $footer_id = 6;//$data->footer;
        $cart = 2;//$data->cart;
        $blog = 1;//$data->news;
        $detail = 1;//$data->detail;
        $shop = 1;//$data->shop;
        $contact = 2;//$data->contact;
        $login = 1;//$data->login;
        $transitions = 2;//$data->transitions;
